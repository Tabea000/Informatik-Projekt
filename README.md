...
Eine steigende Anzahl von "branches", deren Anzahl die Winkel bestimmt, die nach jeder forward-Schritteinheit folgen, führte zu einer Form, die sich immer mehr inem Kreis angleicht, bis keine Ecken mehr sichtbar sind. Eine niedrige Anzahl an forward-Schritten verstärkt den zuvor genannten Effekt, denn nur wenn auch auf flache Winkel eine kure Strecke folgt, ersteht der Eindruck eines Kreises. Dies sind die beiden wichtigsten Werte, die verwendet werden müssen, wichtig ist nur noch, dass "backup" auf 0 gesetzt wird. Eine negative Zahl würde aus dem Kreis die characteristischen Striche herausragen lassen, oder sogar, übersteigt der Wert den der "forward"-Schrittanzahl, die Kreisrichtung umkehren. Im positiven Bereich, würde sich nur die forward-Schrittanzahl erhöhen. Dies ist unserErgebnis:
...
Dieser Screenshot vereint zwei Experimente, mit denen wir das Pinwheel-Kapitel abgeschlossen haben. Zunächst erweiterten wir ein letztes Mal den Pinwheel-Baustein und fürgten die Option "time" hinzu, welche es ermöglichte, die Zeit, die der pen für das Zeichnen benötigte steuern konnte. Nach diesem Zusatz widmeten wir uns der Extraaufgabe, bei welcher wir mithilfe des Pinwheel-Bausteins etwas Zeichnen sollten, was mehr ähnlichkeit mit einem wirklichen pinwheel, einem Windrad, hat. Mithilfe des Pinwheel-Blocks war es uns möglich, das Quadrat, ebenso wie die nach außen ragenden, mittigen Striche zu zeichnen. Für den Rest bastelten wir etwas mit versiedenen Elementen des Programmes, welche wir noch auf dem Script zurückgelassen haben:
